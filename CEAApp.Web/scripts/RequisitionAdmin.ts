...
function LoadAdminDataTable() {
    try {
        ...
        let CostCenter: string = $("#cmbCostCenter").val()!.toString();
        let ExpenditureType: string = $("#cmbExpenditureType").val()!.toString();
        let FiscalYear: number = isNaN(parseInt($("#cmbFiscalYear").val()!.toString())) ? 0 : parseInt($("#cmbFiscalYear").val()!.toString());
        let ProjectNo = $("#txtProjectNo").val()!.toString();
        let RequisitionStatus: string = $("#cmbRequisitionStatus").val()!.toString() == '' ? "" : $("#cmbRequisitionStatus").val()!.toString();
...
function PopulateAdminDataTable(data: any) {
