...
$(function () {
    try {
        ...
        if (!CheckIfNoValue(userCredential)) {
            ...
            GetUserFormAccess(formCode, model.costCenter, model.empNo, PageNameList.RequisitionReport);
        }
        else {
            GetUserCredential(userName, formCode, PageNameList.RequisitionReport);
        }
        // #endregion
    }
    catch (error) {
...
function LoadDataTable() {
    try {
        ...
        $.ajax({
            url: "/ReportFunctions/Report/LoadRequisitionReport",
...
function PopulateDataTable(data) {
    ...
    var dataset = data;
    var reportTitle = "Requisition Report";
