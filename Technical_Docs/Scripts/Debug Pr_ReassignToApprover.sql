DECLARE	@requisitionNo			VARCHAR(12) = '20230137',
		@reassignedByEmpNo		INT = 10003589,
		@reassignedToEmpNo		INT = 10003632,
		@justification			VARCHAR(500) = 'Testing',
		@rowsAffected			INT = 0,
		@hasError				BIT  = 0,
		@retError				INT = 0,
	...
	SELECT @reassignedToID AS reassignedToID,
		@reassignedToFullName AS reassignedToFullName,
		@requisitionStatusID AS requisitionStatusID, 
		@useNewWF AS useNewWF,
		@reassignedByID AS reassignedByID,
		@reassignedByFullName AS reassignedByFullName,
		@submittedForApprovalID AS submittedForApprovalID,
		@reassignedID AS reassignedID

	IF @useNewWF = 0		--CEA request was created using the old system
	BEGIN
	   PRINT 'Goes here old workflow'
		--IF @reassignedToID = 0
		--BEGIN
